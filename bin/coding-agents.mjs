...
6. \`runner.md\`: CLI-issued assignments, parent-integration packets, process-orchestration skeletons, and process runner results.
7. \`audit.md\`: checks and warnings.
8. \`handoff.md\`: prompt for the next worker.
`;
}

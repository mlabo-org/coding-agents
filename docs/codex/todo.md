...
- [ ] T-007.5 Implement real subagent process spawning after a callable runner boundary is selected.
...
- [x] CA-RB-IMPLEMENT-001.1 Implement `verify-assignments` and strengthen `doctor`.
- [x] CA-RB-IMPLEMENT-001.2 Add `assign` packet logging in `docs/codex/runner.md`.
- [x] CA-RB-IMPLEMENT-001.3 Add `collect` parent-integration packet logging.
- [x] CA-RB-IMPLEMENT-001.4 Add `run` / `orchestrate` deferred skeleton logging with `spawned: false`.
- [x] CA-RB-IMPLEMENT-001.5 Run runtime backlog verification and update `audit.md`.
